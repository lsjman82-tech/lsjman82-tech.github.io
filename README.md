                ...
                <section id="experience" class="card h-full">
                    ...
                    <div class="relative pl-6 timeline-line pb-8">
                        ...
                        <div class="text-gray-700 text-xs tracking-tight space-y-2"> 
                            ...
                            <p class="achievement-line"><span class="achievement-icon mr-1">💡</span> [신규 상품] 중고자동차 렌탈 상품 기획 및 런칭 <strong class="text-accent">(프로세스, 렌탈료 산정, 견적서 개발 등 업무 주도), 신규 매출 창출</strong></p> 
                        </div>
                    </div>
